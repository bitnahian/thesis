...
%-------------------- Bibliography
% use  style  'numeric'  or 'alphabetic'
% does not work as a common option anymore:  articletitle=true,
\usepackage[backend=biber,style=alphabetic,doi=false,url=false]{biblatex}
